...
def main(address, model):
    ...
    print("#1 Red 0.5s")
    robot.set_led_color(rby1_sdk.Color(255, 0, 0), duration=0.5, transition_time=0.1, blinking=False)
    time.sleep(0.5)

    print("#2 Green 0.5s")
    robot.set_led_color(rby1_sdk.Color(0, 255, 0), duration=0.5, transition_time=0.1, blinking=False)
    time.sleep(0.5)

    print("#3 Blue 0.5s")
    robot.set_led_color(rby1_sdk.Color(0, 0, 255), duration=0.5, transition_time=0.1, blinking=False)
    time.sleep(0.5)

    print("#4 White Blinking 1s")
    robot.set_led_color(rby1_sdk.Color(200, 200, 200), duration=1, transition_time=0.1, blinking=True, blinking_freq=4)
    time.sleep(1)
