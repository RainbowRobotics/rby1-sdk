...
def main(address, model):
    ...
    robot.set_parameter('default.cartesian_command.stop_joint_position_tracking_error', '0.001')
    ...
    def move_j(position, minimum_time, command_type='jpc'):
        ...
        rv = robot.send_command(rby.RobotCommandBuilder().set_command(
    ...
    ready = np.deg2rad([0.0, 45.0, -90.0, 45.0, 0.0, 0.0]
...
if __name__ == "__main__":
    ...
    parser.add_argument('--address', type=str,
                        required=True, help="Robot address")
