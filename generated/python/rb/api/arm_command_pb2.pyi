...
class ArmCommand(_message.Message):
    ...
    class Request(_message.Message):
        __slots__ = ("command_header", "joint_position_command", "gravity_compensation_command", "cartesian_command", "impedance_control_command")
        ...
        def __init__(self, command_header: _Optional[_Union[_command_header_pb2.CommandHeader.Request, _Mapping]] = ..., joint_position_command: _Optional[_Union[_basic_command_pb2.JointPositionCommand.Request, _Mapping]] = ..., gravity_compensation_command: _Optional[_Union[_basic_command_pb2.GravityCompensationCommand.Request, _Mapping]] = ..., cartesian_command: _Optional[_Union[_basic_command_pb2.CartesianCommand.Request, _Mapping]] = ..., impedance_control_command: _Optional[_Union[_basic_command_pb2.ImpedanceControlCommand.Request, _Mapping]] = ...) -> None: ...
    class Feedback(_message.Message):
        __slots__ = ("command_header_feedback", "joint_position_command_feedback", "gravity_compensation_command_feedback", "cartesian_command_feedback", "impedance_control_command_feedback")
