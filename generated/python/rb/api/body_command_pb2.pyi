...
class BodyCommand(_message.Message):
    ...
    class Request(_message.Message):
        __slots__ = ("command_header", "joint_position_command", "optimal_control_command", "gravity_compensation_command", "cartesian_command", "body_component_based_command")
        ...
        def __init__(self, command_header: _Optional[_Union[_command_header_pb2.CommandHeader.Request, _Mapping]] = ..., joint_position_command: _Optional[_Union[_basic_command_pb2.JointPositionCommand.Request, _Mapping]] = ..., optimal_control_command: _Optional[_Union[_basic_command_pb2.OptimalControlCommand.Request, _Mapping]] = ..., gravity_compensation_command: _Optional[_Union[_basic_command_pb2.GravityCompensationCommand.Request, _Mapping]] = ..., cartesian_command: _Optional[_Union[_basic_command_pb2.CartesianCommand.Request, _Mapping]] = ..., body_component_based_command: _Optional[_Union[_body_component_based_command_pb2.BodyComponentBasedCommand.Request, _Mapping]] = ...) -> None: ...
    class Feedback(_message.Message):
        __slots__ = ("command_header_feedback", "joint_position_command_feedback", "optimal_control_command_feedback", "gravity_compensation_command_feedback", "cartesian_command_feedback", "body_component_based_command_feedback")
