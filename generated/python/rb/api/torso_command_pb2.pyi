...
class TorsoCommand(_message.Message):
    ...
    class Request(_message.Message):
        __slots__ = ("command_header", "joint_position_command", "gravity_compensation_command", "cartesian_command", "impedance_control_command", "optimal_control_command", "joint_impedance_control_command", "cartesian_impedance_control_command")
    ...
    class Feedback(_message.Message):
        __slots__ = ("command_header_feedback", "joint_position_command_feedback", "gravity_compensation_command_feedback", "cartesian_command_feedback", "impedance_control_command_feedback", "optimal_control_command_feedback", "joint_impedance_control_command_feedback", "cartesian_impedance_control_command_feedback")
