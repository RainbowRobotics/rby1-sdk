...
class TorsoCommand(_message.Message):
    ...
    class Request(_message.Message):
        __slots__ = ("command_header", "joint_position_command", "gravity_compensation_command", "cartesian_command", "impedance_control_command", "optimal_control_command", "joint_impedance_control_command", "cartesian_impedance_control_command", "joint_group_position_command")
        ...
        JOINT_GROUP_POSITION_COMMAND_FIELD_NUMBER: _ClassVar[int]
        ...
        joint_group_position_command: _basic_command_pb2.JointGroupPositionCommand.Request
        def __init__(self, command_header: _Optional[_Union[_command_header_pb2.CommandHeader.Request, _Mapping]] = ..., joint_position_command: _Optional[_Union[_basic_command_pb2.JointPositionCommand.Request, _Mapping]] = ..., gravity_compensation_command: _Optional[_Union[_basic_command_pb2.GravityCompensationCommand.Request, _Mapping]] = ..., cartesian_command: _Optional[_Union[_basic_command_pb2.CartesianCommand.Request, _Mapping]] = ..., impedance_control_command: _Optional[_Union[_basic_command_pb2.ImpedanceControlCommand.Request, _Mapping]] = ..., optimal_control_command: _Optional[_Union[_basic_command_pb2.OptimalControlCommand.Request, _Mapping]] = ..., joint_impedance_control_command: _Optional[_Union[_basic_command_pb2.JointImpedanceControlCommand.Request, _Mapping]] = ..., cartesian_impedance_control_command: _Optional[_Union[_basic_command_pb2.CartesianImpedanceControlCommand.Request, _Mapping]] = ..., joint_group_position_command: _Optional[_Union[_basic_command_pb2.JointGroupPositionCommand.Request, _Mapping]] = ...) -> None: ...
    class Feedback(_message.Message):
        __slots__ = ("command_header_feedback", "joint_position_command_feedback", "gravity_compensation_command_feedback", "cartesian_command_feedback", "impedance_control_command_feedback", "optimal_control_command_feedback", "joint_impedance_control_command_feedback", "cartesian_impedance_control_command_feedback", "joint_group_position_command_feedback")
        ...
        JOINT_GROUP_POSITION_COMMAND_FEEDBACK_FIELD_NUMBER: _ClassVar[int]
        ...
        joint_group_position_command_feedback: _basic_command_pb2.JointGroupPositionCommand.Feedback
        def __init__(self, command_header_feedback: _Optional[_Union[_command_header_pb2.CommandHeader.Feedback, _Mapping]] = ..., joint_position_command_feedback: _Optional[_Union[_basic_command_pb2.JointPositionCommand.Feedback, _Mapping]] = ..., gravity_compensation_command_feedback: _Optional[_Union[_basic_command_pb2.GravityCompensationCommand.Feedback, _Mapping]] = ..., cartesian_command_feedback: _Optional[_Union[_basic_command_pb2.CartesianCommand.Feedback, _Mapping]] = ..., impedance_control_command_feedback: _Optional[_Union[_basic_command_pb2.ImpedanceControlCommand.Feedback, _Mapping]] = ..., optimal_control_command_feedback: _Optional[_Union[_basic_command_pb2.OptimalControlCommand.Feedback, _Mapping]] = ..., joint_impedance_control_command_feedback: _Optional[_Union[_basic_command_pb2.JointImpedanceControlCommand.Feedback, _Mapping]] = ..., cartesian_impedance_control_command_feedback: _Optional[_Union[_basic_command_pb2.CartesianImpedanceControlCommand.Feedback, _Mapping]] = ..., joint_group_position_command_feedback: _Optional[_Union[_basic_command_pb2.JointGroupPositionCommand.Feedback, _Mapping]] = ...) -> None: ...
