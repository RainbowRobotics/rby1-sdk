...
class WholeBodyCommand(_message.Message):
    ...
    class Request(_message.Message):
        __slots__ = ("command_header", "stop_command")
    ...
    class Feedback(_message.Message):
        __slots__ = ("command_header_feedback", "stop_command_feedback")
        ...
        def __init__(self, command_header_feedback: _Optional[_Union[_command_header_pb2.CommandHeader.Feedback, _Mapping]] = ..., stop_command_feedback: _Optional[_Union[_basic_command_pb2.StopCommand.Feedback, _Mapping]] = ...) -> None: ...
