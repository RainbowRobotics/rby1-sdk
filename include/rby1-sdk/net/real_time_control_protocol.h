...
// ControlInput : UPC -> RPC
// 0x24 0x24 len:ushort N:uchar Mode:uchar[0...N-1] T:double[0...N-1] FBG:uint[0...N-1] FFT:double[0...N-1] Finished:uchar CRC 0x25 0x25

static constexpr bool kPositionControlMode = false;
